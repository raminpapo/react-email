# Documentation: themes.ts
**File Path:** `packages/code-block/src/themes.ts`
**Language:** typescript
**Size:** 82,925 bytes
**Lines:** 4,930
**Generated:** 2025-11-15T20:37:31.741418Z
...
- **Path:** `packages/code-block/src/themes.ts`
- **Name:** `themes.ts`
- **Extension:** `.ts`
- **Language:** typescript
- **Size:** 82,925 bytes (80.98 KB)
- **Lines of Code:** 4,930
...
- `A3BE8C`
- `A8FF60`
- `AGlu0Cb5HTx9KuAEieGJEdcehS3eRTp2ATdt3CpIm`
- `AL3yRalXLyKqAIIfk`
- `ANLbMO`
- `AWrgBN8uNFAl`
- `Andale`
- `AuIXBhN8gGWnstefhiZyWvLAEnbYS1uzSFP6Jvn4Baxx70JKkQojLib5AVTey1jjgkKJGO0AKWyOm7N7cSpgSpAdPH0Tfd`
- `B0C975`
- `B48EAD`
- `BC94F9`
- `BHdU8CLYFY5bMAd`
- `BTnkAJvkLkJe`
- `BafQGt93LVMxJTv8ABts4CVLhcfYWsCb5kC9`
- `Bitstream`
- `C6C5FE`
- `CSSProperties`
- `Code`
...
- `E45734`
- `E9C062`
- `EAF4AAQEBAAAAAAAAAAAAAAAAAAABBwEBAQAAAAAAAAAAAAAAAAAAAAIQAAEDAwIHAQEAAAAAAAAAAADwAREhYaExkUFRcYGxwdHh8REBAAAAAAAAAAAAAAAAAAAAAP`
- `EBCB8B`
- `F05E5D`
- `F9EE98`
- `FCFCD6`
...
- `FFFFB6`
- `Fira`
- `GEWntIi2P0BooyFxcNr8Ep3`
- `Grammar`
- `Inconsolata`
- `Ja32Yi5haAKWz4Ydm2cSpgU693Atb7km`
- `Liberation`
- `Lucida`
- `Menlo`
- `Monaco`
...
- `QC0Fb4YUVRFsAOvj4KW2dwtYE3yAWk`
- `QFVA3wR`
- `QtPpa3wBO3sVvszCnLAhkzgL5`
- `QtZwAhROXFeb7swp`
- `QyhvbiqdgC0kVvgUUiLYgBS2QtPbiVI1`
- `RKkaW2Yq4AQtVBBFsAJU`
- `RLf13cAuDeBS2RpbtAm`
- `RLf13cLQd8`
- `RWOWBtu7`
- `React`
...
- `Roboto`
- `Sans`
- `TClsgJUwKJ5FVA7tvIFrfZhVfGJDcsCKaYgAqv6YRbE`
- `Theme`
- `Typewriter`
- `Ubuntu`
- `Vera`
...
- `a89984`
- `a9b7c6`
- `aAAwDAQACEQMRAD8AyGFEjHaBS2fDDs2zkhKmBKktb7km`
- `aaaaca`
- `aabfc9`
- `abe338`
- `ac9739`
...
- `b5cea8`
- `b6ad9a`
- `b7sAXFxFn2YLUU5Ns7gFX8C4ib`
- `b89859`
- `b8bb26`
- `b9b5b8`
- `bAIQACQYGBgcGCQcHCQ0IBwgNDwsJCQsPEQ4ODw4OERENDg4ODg0RERQUFhQUERoaHBwaGiYmJiYmKysrKysrKysrKwEJCAgJCgkMCgoMDwwODA8TDg4ODhMVDg4PDg4VGhMRERERExoXGhYWFhoXHR0aGh0dJCQjJCQrKysrKysrKysr`
- `background`
