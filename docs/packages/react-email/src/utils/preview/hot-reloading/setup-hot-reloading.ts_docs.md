# Documentation: setup-hot-reloading.ts
**File Path:** `packages/react-email/src/utils/preview/hot-reloading/setup-hot-reloading.ts`
**Language:** typescript
**Size:** 3,845 bytes
**Lines:** 122
**Generated:** 2025-11-15T20:37:32.562890Z
...
- **Path:** `packages/react-email/src/utils/preview/hot-reloading/setup-hot-reloading.ts`
- **Name:** `setup-hot-reloading.ts`
- **Extension:** `.ts`
- **Language:** typescript
...
- `exit()`
- `file()`
- `filesOutsideEmailsDirectory()`
- `getFilesOutsideEmailsDirectory()`
- `io()`
- `newFilesOutsideEmailsDirectory()`
- `pathToChangeTarget()`
- `reload()`
- `setupHotreloading()`
- `watcher()`
