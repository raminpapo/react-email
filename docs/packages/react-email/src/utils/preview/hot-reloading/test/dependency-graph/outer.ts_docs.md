# Documentation: outer.ts
**File Path:** `packages/react-email/src/utils/preview/hot-reloading/test/dependency-graph/outer.ts`
**Language:** typescript
**Size:** 221 bytes
**Lines:** 6
**Generated:** 2025-11-15T20:37:32.568584Z
...
- **Path:** `packages/react-email/src/utils/preview/hot-reloading/test/dependency-graph/outer.ts`
- **Name:** `outer.ts`
- **Extension:** `.ts`
- **Language:** typescript
