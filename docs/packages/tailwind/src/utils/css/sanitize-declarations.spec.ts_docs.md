# Documentation: sanitize-declarations.spec.ts
**File Path:** `packages/tailwind/src/utils/css/sanitize-declarations.spec.ts`
**Language:** typescript
**Size:** 9,615 bytes
**Lines:** 312
**Generated:** 2025-11-15T20:37:32.466588Z
...
- **Path:** `packages/tailwind/src/utils/css/sanitize-declarations.spec.ts`
- **Name:** `sanitize-declarations.spec.ts`
- **Extension:** `.ts`
- **Language:** typescript
