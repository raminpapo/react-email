# Documentation: sanitize-non-inlinable-rules.spec.ts.snap
**File Path:** `packages/tailwind/src/utils/css/__snapshots__/sanitize-non-inlinable-rules.spec.ts.snap`
**Language:** Unknown
**Size:** 2,157 bytes
**Lines:** 8
**Generated:** 2025-11-15T20:37:32.488875Z
...
- **Path:** `packages/tailwind/src/utils/css/__snapshots__/sanitize-non-inlinable-rules.spec.ts.snap`
- **Name:** `sanitize-non-inlinable-rules.spec.ts.snap`
- **Extension:** `.snap`
- **Language:** Unknown
