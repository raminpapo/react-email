# Documentation: parse-padding.ts
**File Path:** `packages/button/src/utils/parse-padding.ts`
**Language:** typescript
**Size:** 3,324 bytes
**Lines:** 138
**Generated:** 2025-11-15T20:37:32.221533Z
...
- **Path:** `packages/button/src/utils/parse-padding.ts`
- **Name:** `parse-padding.ts`
- **Extension:** `.ts`
- **Language:** typescript
