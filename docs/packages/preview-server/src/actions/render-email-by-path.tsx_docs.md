# Documentation: render-email-by-path.tsx
**File Path:** `packages/preview-server/src/actions/render-email-by-path.tsx`
**Language:** tsx
**Size:** 7,523 bytes
**Lines:** 246
**Generated:** 2025-11-15T20:37:31.783288Z
...
- **Path:** `packages/preview-server/src/actions/render-email-by-path.tsx`
- **Name:** `render-email-by-path.tsx`
- **Extension:** `.tsx`
- **Language:** tsx
- **Size:** 7,523 bytes (7.35 KB)
- **Lines of Code:** 246
...
- `emailFilename()`
- `error()`
- `findClosestAttributeValue()`
- `jsxRuntimePath()`
- `markup()`
- `markupWithReferences()`
- `millisecondsToBundled()`
- `millisecondsToRendered()`
- `originalJsxRuntimePath()`
- `plainText()`
- `prettyMarkup()`
- `previewProps()`
...
- `renderEmailByPath()`
- `sourceFile()`
- `sourceFileAttributeMatches()`
- `sourceLine()`
- `stack()`
- `timeBeforeEmailBundled()`
- `timeBeforeEmailRendered()`
- `timeForConsole()`
...
- `../app/env`
- `../utils/convert-stack-with-sourcemap`
- `../utils/create-jsx-runtime`
- `../utils/get-email-component`
- `../utils/register-spinner-autostopping`
- `../utils/style-text`
