# Documentation: load.json
**File Path:** `packages/preview-server/src/animated-icons-data/load.json`
**Language:** json
**Size:** 13,453 bytes
**Lines:** 444
**Generated:** 2025-11-15T20:37:32.108529Z
...
- **Path:** `packages/preview-server/src/animated-icons-data/load.json`
- **Name:** `load.json`
- **Extension:** `.json`
- **Language:** json
- **Size:** 13,453 bytes (13.14 KB)
- **Lines of Code:** 444
