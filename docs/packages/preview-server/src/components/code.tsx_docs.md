...
**File Path:** `packages/preview-server/src/components/code.tsx`
**Language:** tsx
**Size:** 6,088 bytes
**Lines:** 186
**Generated:** 2025-11-15T20:37:32.118804Z
...
- **Path:** `packages/preview-server/src/components/code.tsx`
- **Name:** `code.tsx`
- **Extension:** `.tsx`
- **Language:** tsx
