# Documentation: icon-folder-open.tsx
**File Path:** `packages/preview-server/src/components/icons/icon-folder-open.tsx`
**Language:** tsx
**Size:** 1,437 bytes
**Lines:** 20
**Generated:** 2025-11-15T20:37:32.152078Z
...
- **Path:** `packages/preview-server/src/components/icons/icon-folder-open.tsx`
- **Name:** `icon-folder-open.tsx`
- **Extension:** `.tsx`
- **Language:** tsx
