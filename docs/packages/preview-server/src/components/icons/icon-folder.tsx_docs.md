# Documentation: icon-folder.tsx
**File Path:** `packages/preview-server/src/components/icons/icon-folder.tsx`
**Language:** tsx
**Size:** 950 bytes
**Lines:** 19
**Generated:** 2025-11-15T20:37:32.153205Z
...
- **Path:** `packages/preview-server/src/components/icons/icon-folder.tsx`
- **Name:** `icon-folder.tsx`
- **Extension:** `.tsx`
- **Language:** tsx
